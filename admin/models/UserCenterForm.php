        ...
        return [
            ...
            'menus' => [
                [
                    'id' => 'tuwen',
                    'name' => '我的图文',
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-user-tw.png',
                    'open_type' => 'navigator',
                    'url' => '/subpages/graphic/graphic',
                    'tel' => '',
                ],
                [
                    'id' => 'pintuan',
                ...
                [
                    ...
                    'open_type' => 'navigator',
                    'url' => '/subpages/coupon-list/coupon-list',
                    'tel' => '',
                ],
                [
                    'id' => 'shoucang',
                    ...
                    'open_type' => 'navigator',
                    'url' => '/subpages/favorite/favorite',
                    'tel' => '',
                ],
                [
                    'id' => 'kefu',
                ...
                [
                    ...
                    'open_type' => 'navigator',
                    'url' => '/subpages/article-list/article-list?id=2',
                    'tel' => '',
                ],
                [
                    'id' => 'guanyu',
                    ...
                    'open_type' => 'navigator',
                    'url' => '/subpages/article-detail/article-detail?id=about_us',
                    'tel' => '',
                ],
                [
                    'id' => 'miaosha',
                ...
                [
                    ...
                    'open_type' => 'navigator',
                    'url' => '/subpages/bangding/bangding',
                    'tel' => '',
                ],
                [
                    'id' => 'mch',
                ...
                [
                    ...
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-order-1.png',
                    'open_type' => 'navigator',
                    'url' => '/subpages/order/order?status=1',
                    'tel' => '',
                ],
                [
                    'id' => 'un_confirm',
                    ...
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-order-2.png',
                    'open_type' => 'navigator',
                    'url' => '/subpages/order/order?status=2',
                    'tel' => '',
                ],
                [
                    'id' => 'complete',
                    ...
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-order-3.png',
                    'open_type' => 'navigator',
                    'url' => '/subpages/order/order?status=3',
                    'tel' => '',
                ],
                [
                    'id' => 'refund',
                    ...
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-order-4.png',
                    'open_type' => 'navigator',
                    'url' => '/subpages/order/order?status=4',
                    'tel' => '',
                ],
                [
                    'id' => 'integral',
                    ...
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-user-yhq.png',
                    'open_type' => 'navigator',
                    'url' => '/subpages/integral-mall/order/order',
                    'tel' => '',
                ],
            ],
            'copyright' => [
