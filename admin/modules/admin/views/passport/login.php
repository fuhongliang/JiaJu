...
$copyright = $copyright ? $copyright : '©2018 <a href="javascript：void(0);" target="_blank">富方科技</a>';

$passport_bg = Option::get('passport_bg', 0, 'admin', Yii::$app->request->baseUrl . '/statics/admin/images/bg.png');
?>
<style>
    html {
        position: relative;
...
<div class="main" id="app">
    ...
    <div class="header">
        <a href="<?= Yii::$app->request->baseUrl ?>"><img class="logo" src="<?= $logo ?>"></a>
    </div>
    <form method="post" class="auto-submit-form card"
          return="<?= Yii::$app->request->get('return_url') ?>">
        <div class="card-body">
            <h1>登录管理后台</h1>
            ...
            <div class="form-inline mb-3">
                <div class="w-100">
                    <input class="form-control" name="captcha_code" placeholder="图片验证码" style="width: 180px">
                    <img class="refresh-captcha"
                         ...
                         style="height: 33px;width: 100px;float: right;cursor: pointer;" title="点击刷新验证码">
                </div>
            </div>
