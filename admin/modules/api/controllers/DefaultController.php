...
use app\modules\api\models\MasterForm;
use app\modules\api\models\MasterListForm;
use app\modules\api\models\MchListForm;
...
class DefaultController extends Controller
{
    ...
    public function actionMchArticle()
    {
        $data = \Yii::$app->request->get();
        $topicList = Topic::find()->where([
            'mch_id'=> $data['mch_id'],
            'is_delete' => 0,
        ])->all();
