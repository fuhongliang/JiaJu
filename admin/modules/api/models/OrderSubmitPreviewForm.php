...
//        }
    ...
    private function getCouponList($goods_total_price, $cat_ids, $coupon_goods_id)
    {
        $list = UserCoupon::find()->alias('uc')
            ...
            ->select('uc.id user_coupon_id,c.sub_price,c.min_price,cas.event,uc.begin_time,uc.end_time,uc.type,c.appoint_type,c.cat_id_list,c.goods_id_list,c.name as coupon_title')
            ->asArray()->all();
