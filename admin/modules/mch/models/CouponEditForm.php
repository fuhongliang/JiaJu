...
class CouponEditForm extends MchModel
{
    ...
    public function rules()
    {
        return [
            [['name'], 'trim'],
            [['user_type','name', 'discount_type', 'min_price', 'sub_price', 'discount', 'expire_type', 'expire_day', 'begin_time', 'end_time'], 'required'],
    ...
    public function save()
    {
        ...
        $this->coupon->user_type = $this->user_type;
        $old_cat_id_list = json_decode($this->coupon->cat_id_list);
        if (empty($old_cat_id_list)) {
