...
//    public $member_discount;
    ...
    public function rules()
    {
        return [
            ...
            [['share_commission_first', 'share_commission_second', 'share_commission_third', 'freight', 'rebate', 'virtual_sales', 'individual_share','goods_no','show_integral'], 'default', 'value' => 0],
            [['share_commission_first', 'share_commission_second', 'share_commission_third', 'rebate', 'weight','cost_price'], 'number', 'min' => 0,'max' => 999999],
            [['goods_num', 'virtual_sales', 'sort', 'freight','show_integral'], 'integer', 'min' => 0,'max'=>999999],
            [['use_attr'], 'safe'],
