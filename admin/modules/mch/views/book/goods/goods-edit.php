        ...
        <form class="form auto-form" method="post" autocomplete="off" data-return="<?= $returnUrl ?>">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#step1" role="tab"
                       aria-controls="basic-info" aria-selected="true">选择分类</a>
                    <a class="nav-item nav-link" id="stock-attr-tab" data-toggle="tab" href="#step2" role="tab"
                       aria-controls="stock-attr" aria-selected="false">基本信息</a>
                    <a class="nav-item nav-link" id="share-info-tab" data-toggle="tab" href="#step5" role="tab"
                       aria-controls="share-info" aria-selected="false">分销设置</a>
                    <a class="nav-item nav-link" id="image-video-tab" data-toggle="tab" href="#step3" role="tab"
                       aria-controls="image-video" aria-selected="false">图片视频</a>
                    <a class="nav-item nav-link" id="goods-desc-tab" data-toggle="tab" href="#step4" role="tab"
                       aria-controls="goods-desc" aria-selected="false">商品详情</a>
                </div>
            </nav>
