...
<div class="modal fade" id="file_select_modal" data-backdrop="static">
    <div class="modal-dialog modal-xl" role="document" style="max-width: 901px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">选择文件</h5>
                <button type="button" class="close panel-close cancel-group-list" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="file" style="display: none">
                <div class="mb-3 clearfix pb-3" style="border-bottom: 1px solid #eee;">
                    <div class="float-right">
                        <div flex="dir:left cross:center">
                            <div class="upload-group custom-control custom-checkbox">
                                <label class="checkbox-label">
                                    <input type="checkbox" class="custom-control-input" name="checkbox" value="1">
                                    <span class="label-icon"></span>
                                    <span class="label-text custom-control-label">全选</span>
                                </label>
                            </div>
                ...
                <div flex="dir:left main:left" style="height: 480px;">
                    <div class="left mr-3" style="height: 100%;width:120px;overflow-y: auto">
                        <div class="item text-center add-group"><span class="item-icon iconfont icon-tianjia"></span>
                            添加分组
                        </div>
                            ...
                            <div :class="index==selected?'item selected-group active':'item selected-group'"
                                ...
                                <template v-if="index == edit_group">
                                    <div class="pt-3" flex="dir:left cross:center">
                                        <span class="item-icon iconfont icon-wenjian"></span>
                                ...
                                <template v-else>
                                    <div flex="dir:left cross:center">
                                        <span class="item-icon iconfont icon-wenjian mr-3"></span>
                                        <div class="text-more">{{item.name}}</div>
                                        <template v-if="item.is_default != 1">
                                        <span class="item-icon iconfont icon-icon_shezhi setting-group"
                    ...
                    <div class="file-list" style="width: 750px;overflow-y: auto;">
            ...
            <div class="modal-footer text-center">
                <button type="button" class="btn btn-secondary cancel-group-list" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary save-group-list ">确定</button>
            </div>
        </div>
    </div>
</div>
