...
<div id="pick_link_modal">
    <div class="modal fade pick-link-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <label class="input-group-text">可选链接</label>
                        </div>
                ...
                <div class="modal-footer">
                    <a class="btn btn-primary pick-link-confirm" href="javascript:void(0);">确定</a>
                </div>
            </div>
        </div>
    </div>
        ...
        pick_link_modal = new Vue({
            ...
            data: {
                ...
                link_list: [
                    ...
                    {
                        name: "装修方案详情",
                        link: "/pages/graphic-details/graphic-details",
                        open_type: "navigate",
                        params: [
                            {
                                key: "id",
