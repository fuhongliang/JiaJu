    ...
    <div class="panel-body">
        <form class="auto-form" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="active-start" <?= $model->game_open == 1 ? 'checked' : null ?>
                               value="1"
                               name="game_open" type="radio" class="custom-control-input">
                        <label class="custom-control-label" for="active-start">开启</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="active-close" <?= $model->game_open == 0 ? 'checked' : null ?>
                               value="0"
                               name="game_open" type="radio" class="custom-control-input">
                        <label class="custom-control-label" for="active-close">关闭</label>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="hb-average" <?= $model->distribute_type == 1 ? 'checked' : null ?>
                               value="1"
                               name="distribute_type" type="radio" class="custom-control-input">
                        <label class="custom-control-label" for="hb-average">平均</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="hb-random" <?= $model->distribute_type == 0 ? 'checked' : null ?>
                               value="0"
                               name="distribute_type" type="radio" class="custom-control-input">
                        <label class="custom-control-label" for="hb-random">随机</label>
                    </div>
                </div>
            </div>
