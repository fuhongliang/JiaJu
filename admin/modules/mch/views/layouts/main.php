...
?>
    ...
    <head>
        ...
        <?php if ($new === true): ?>
            <link href="<?= Yii::$app->request->baseUrl ?>/statics/new/tether-1.3.3/dist/css/theme.min.css" rel="stylesheet">
            <link href="<?= Yii::$app->request->baseUrl ?>/statics/new/bootstrap-4.3.1/css/bootstrap.min.css"
                  rel="stylesheet">
        <?php else: ?>
        ...
        <link href="<?= Yii::$app->request->baseUrl ?>/statics/fontawesome/css/all.css" rel="stylesheet">
        ...
        <link href="<?= Yii::$app->request->baseUrl ?>/statics/mch/css/common.v2.css?version=<?= $version ?>" rel="stylesheet">
        ...
        <?php if ($new === true): ?>
            <script src="<?= Yii::$app->request->baseUrl ?>/statics/new/jquery/jquery.min.js"></script>
            <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js" integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin="anonymous"></script>
            <script src="<?= Yii::$app->request->baseUrl ?>/statics/new/bootstrap-4.3.1/js/bootstrap.min.js"></script>
        <?php else: ?>
    ...
    <div class="sidebar <?= $current_menu && count($current_menu['children']) ? 'sidebar-sub' : null ?>">
        <div class="sidebar-1">
            <div class="logo">
                <a class="home-link"
                   href="<?= $urlManager->createUrl(['mch/default/index']) ?>"><i style="font-size: 1rem;" class="fas fa-laugh-wink"></i>&nbsp;<?= $this->context->store->name ?></a>
            </div>
            <div>
