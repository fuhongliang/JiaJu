...
<div class="pd-white-box" id="app">
    <div class="wrap">
        <form class="auto-form" method="post" return="<?= Yii::$app->request->referrer ? Yii::$app->request->referrer : '' ?>">
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right required">
                    <label class="col-form-label required">登录名</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right required">
                    <label class="col-form-label required">邮箱</label>
                </div>
                <div class="col-sm-6">
                    <input type="email" class="form-control">
                    <div class="text-muted fs-sm">添加成功后 该邮箱收到登录名、密码相关信息</div>
                </div>
            </div>
