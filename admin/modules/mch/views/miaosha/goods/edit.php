            ...
            <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group short-row">
                                ...
                                <span class="input-group-btn">
                                    <a class="btn btn-outline-secondary copy-btn" href="javascript:">立即获取</a>
                                </span>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group short-row">
                                ...
                                <span class="input-group-btn">
                                    <a class="btn btn-outline-secondary mall-copy-btn" href="javascript:">立即获取</a>
                                </span>
                            </div>
                            <div class="short-row text-muted fs-sm">若不使用，则该项为空</div>
                            <div class="copy-error text-danger fs-sm" hidden></div>
                ...
                <div class="tab-pane fade" id="share-info" role="tabpanel" aria-labelledby="share-info-tab">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 col-form-label">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="discount-yes" <?= $goods['is_discount'] == 1 ? 'checked' : 'checked' ?>
                                       value="1"
                                       name="model[is_discount]" type="radio" class="custom-control-input">
                                <label class="custom-control-label" for="discount-yes">是</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="discount-no" <?= $goods['is_discount'] == 0 ? 'checked' : null ?>
                                       value="0"
                                       name="model[is_discount]" type="radio" class="custom-control-input">
                                <label class="custom-control-label" for="discount-no">否</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 col-form-label">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="coupon-yes" <?= $goods['coupon'] == 1 ? 'checked' : checked ?>
                                       value="1"
                                       name="model[coupon]" type="radio" class="custom-control-input">
                                <label class="custom-control-label" for="coupon-yes">是</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="coupon-no" <?= $goods['coupon'] == 0 ? 'checked' : null ?>
                                       value="0"
                                       name="model[coupon]" type="radio" class="custom-control-input">
                                <label class="custom-control-label" for="coupon-no">否</label>
                            </div>
                        ...
                        <div class="col-sm-6 col-form-label">
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input <?= $payment['wechat'] == 1 ? 'checked' : null ?>
                                        value="1"
                                        id="wechat" name="model[payment][wechat]" type="checkbox" class="custom-control-input">
                                <label class="custom-control-label" for="wechat">微信支付</label>
                            </div>
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input <?= $payment['huodao'] == 1 ? 'checked' : null ?>
                                        value="1"
                                        id="huodao" name="model[payment][huodao]" type="checkbox" class="custom-control-input">
                                <label class="custom-control-label" for="huodao">货到付款</label>
                            </div>
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input  <?= $payment['balance'] == 1 ? 'checked' : null ?>
                                        value="1"
                                        id="balance" name="model[payment][balance]" type="checkbox" class="custom-control-input">
                                <label class="custom-control-label" for="balance">余额支付</label>
                            </div>
