...
<ul class="nav nav-tabs-custom">
    <li class="active"><a href="javascript:void(0);">秒杀订单</a></li>
    <span>/</span>
    <li><?= $this->title ?></li>
</ul>
<?php $this->endBlock(); ?>
                                ...
                                <div>
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <a class="btn btn-outline-secondary" id="show_date_start" href="javascript:">
                                                <span class="iconfont icon-date_range"></span>
                                            </a>
                                        </span>
                                        ...
                                        <span class="input-group-btn">
                                            <a class="btn btn-outline-secondary" id="show_date_end" href="javascript:">
                                                <span class="iconfont icon-date_range"></span>
                                            </a>
                                        </span>
                                    </div>
