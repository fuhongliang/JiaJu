...
<ul class="nav nav-tabs-custom">
    <li class="<?= $status == -1 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['status' => -1])) ?>">全部</a></li>
    <li class="<?= $status == 0 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['status' => 0])) ?>">未付款<?= $store_data['status_count']['status_0'] ? '(' . $store_data['status_count']['status_0'] . ')' : null ?></a></li>
    <li class="<?= $status == 1 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['status' => 1])) ?>">待发货<?= $store_data['status_count']['status_1'] ? '(' . $store_data['status_count']['status_1'] . ')' : null ?></a></li>
    <li class="<?= $status == 2 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['status' => 2])) ?>">待收货<?= $store_data['status_count']['status_2'] ? '(' . $store_data['status_count']['status_2'] . ')' : null ?></a></li>
    <li class="<?= $status == 3 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['status' => 3])) ?>">已完成<?= $store_data['status_count']['status_3'] ? '(' . $store_data['status_count']['status_3'] . ')' : null ?></a></li>
    <li class="<?= $status == 6 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['status' => 6])) ?>">待处理<?= $store_data['status_count']['status_6'] ? '(' . $store_data['status_count']['status_6'] . ')' : null ?></a></li>
    <li class="<?= $status == 5 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['status' => 5])) ?>">已取消<?= $store_data['status_count']['status_5'] ? '(' . $store_data['status_count']['status_5'] . ')' : null ?></a></li>
    <li class="<?= $status == 7 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['status' => 7])) ?>">异常订单</a></li>
    <li class="<?= $is_recycle == 1 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge([$_GET['r']], $condition, ['is_recycle' => 1])) ?>">回收站</a></li>
</ul>
<?php $this->endBlock(); ?>
                ...
                <div class="mr-4">
                    <div class="form-group row">
                        ...
                        <div class="middle-center">
                            <button class="new-day btn btn-primary" data-index="7">近7天</button>
                            <button class="new-day btn btn-primary" data-index="30">近30天</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-bordered bg-white">
                    <tr>
                        <td colspan="5">
                            ...
                            <span>会员手机号：<?= $order_item['other_mobile'] ?></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="order-tab-5">
                            ...
                            <div class="mb-2">
                                <a class="btn btn-sm btn-primary" href="<?= $urlManager->createUrl(['mch/order/detail', 'order_id' => $order_item['id']]) ?>">添加备注</a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <div class="col-9">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input value="1" checked
                                       ...
                                       class="custom-control-input is-express" id="is_express_yes">
                                <label class="custom-control-label" for="is_express_yes">快递</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="is_express_no" value="0" name="is_express" type="radio"
                                       class="custom-control-input is-express">
                                <label class="custom-control-label" for="is_express_no">无需物流</label>
                            </div>
                        </div>
                    </div>
