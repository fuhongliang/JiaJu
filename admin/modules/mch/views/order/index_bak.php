...
<div class="pd-white-box">
    ...
    <div class="search-box">
        <form class="form-inline custom-inline">
            <div class="form-group">
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">所属团长</span>
                    </div>
            ...
            <div class="form-group">
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">会员</span>
                    </div>
                    <input type="text" class="form-control" placeholder="会员昵称">
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text">所属路线</label>
                    </div>
                    <select class="form-control">
                        <option value="">请选择</option>
                        <option value="201904100100305089">成新青线路</option>
                        <option value="201904072047429576">东线</option>
                        <option value="201904071448549123">23242</option>
                        <option value="201904052254455820">888888888888888</option>
                        <option value="201904050919132287">idxe</option>
                        <option value="201904050915298840">1</option>
                        <option value="201904041949435319">线路1</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text">支付方式</label>
                    </div>
                    <select class="form-control">
                        <option value="">请选择</option>
                        <option value="1">余额</option>
                        <option value="2">微信</option>
                        <option value="3">微信+余额</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group ">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="输入订单号" aria-label="Text input with dropdown button">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text">配送类型</label>
                    </div>
                    <select class="form-control">
                        <option value="">请选择</option>
                        <option value="1">到点自提</option>
                        <option value="2">团长配送</option>
    ...
    <div class="table-act-row">
        <a class="btn btn-primary btn-sm blue_new" href="/backend/web/index.php/page/management_create">发布商品</a>
        <a class="btn btn-primary btn-sm blue_new" href="/backend/web/index.php/page/management_create">批量导出</a>
    </div>
                        ...
                        <div flex="dir:left">
                                ...
                                <div class="form-group row w-20">
                                    <div class="col-5">
                                        <select class="form-control" name="keyword_1">
                                            <option value="1" <?= $_GET['keyword_1'] == 1 ? "selected" : "" ?> title="订单号">订单号</option>
                                            <option value="2" <?= $_GET['keyword_1'] == 2 ? "selected" : "" ?> title="用户">用户</option>
                                            <option value="3" <?= $_GET['keyword_1'] == 3 ? "selected" : "" ?> title="收货人">收货人</option>
                                        </select>
                                    </div>
                                    <div class="col-7">
                            ...
                            <div class="mr-4">
                                <div class="form-group row">
                                    <div>
                                        <label class="middle-center">下单时间：</label>
                                    </div>
                                    <div>
                                    ...
                                    <div class="middle-center">
                                        <button class="new-day btn btn-primary mr-4" data-index="7">近7天</button>
                                        <button class="new-day btn btn-primary mr-4" data-index="30">近30天</button>
                                    </div>
                                </div>
                            </div>
                        </div>
