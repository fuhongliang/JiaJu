...
<ul class="nav nav-tabs-custom">
    <li class="<?= $status == -1 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(['mch/order/refund']) ?>">全部</a></li>
    <li class="<?= $status == 0 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(['mch/order/refund', 'status' => 0]) ?>">待处理</a></li>
    <li class="<?= $status == 1 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(['mch/order/refund', 'status' => 1]) ?>">已处理</a></li>
</ul>
<?php $this->endBlock(); ?>
                                ...
                                <div>
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <a class="btn btn-outline-secondary" id="show_date_start" href="javascript:void(0);"><span class="iconfont icon-date_range"></span></a>
                                        </div>
                                        ...
                                        <div class="input-group-append">
                                            <a class="btn btn-outline-secondary" id="show_date_end" href="javascript:void(0)"><span class="iconfont icon-date_range"></span></a>
                                        </div>
                                    </div>
                                </div>
...
<div class="img-view-box" flex="cross:center main:center">
    <a class="img-view-close" href="javascript:">×</a><img src="">
</div>
