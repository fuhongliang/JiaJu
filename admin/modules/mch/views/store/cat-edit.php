            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <select class="form-control parent" name="model[parent_id]">
                        ...
                        <?php foreach ($parent_list as $key=>$cat): ?>
                            <option <?php if($cat->is_show==3):?>disabled<?php endif;?> value="<?= $cat->id ?>" <?= $cat->id== $list['parent_id'] ? 'selected' : '' ?>><?= $cat->name ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
                    ...
                    <div class="upload-group">
                        <div class="upload-group">
                            <div class="input-group">
                                <input type="text" class="form-control file-input" name="model[pic_url]" value="<?= $list['pic_url'] ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <div class="upload-group">
                        <div class="upload-group">
                            <div class="input-group">
                                <input type="text" class="form-control file-input" name="model[big_pic_url]" value="<?= $list['big_pic_url'] ?>">
                                <div class="input-group-append">
                                    <a class="btn btn-outline-secondary upload-file" href="javascript:void(0);" title="上传文件"><span class="iconfont icon-shangchuan"></span></a>
                                    <a class="btn btn-outline-secondary select-file" href="javascript:void(0);" title="从文件库选择"><span class="iconfont icon-lishituku"></span></a>
                                    <a class="btn btn-outline-secondary delete-file" href="javascript:void(0);" title="删除文件"><span class="iconfont icon-shanchu"></span></a>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <div class="upload-group">
                            <div class="upload-group">
                                <div class="input-group">
                                    <input type="text" class="form-control file-input" name="model[advert_pic]" value="<?= $list['advert_pic'] ?>">
                                    <div class="input-group-append">
                                        <a class="btn btn-outline-secondary upload-file" href="javascript:void(0);" title="上传文件"><span class="iconfont icon-shangchuan"></span></a>
                                        <a class="btn btn-outline-secondary select-file" href="javascript:void(0);" title="从文件库选择"><span class="iconfont icon-lishituku"></span></a>
                                        <a class="btn btn-outline-secondary delete-file" href="javascript:void(0);" title="删除文件"><span class="iconfont icon-shanchu"></span></a>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group page-link-input">
                            <input type="text" class="form-control link-input advert_url" name="model[advert_url]" value="<?= $list['advert_url'] ?>" readonly>
                            <div class="input-group-append">
                                <a class="btn btn-outline-secondary pick-link-btn" href="javascript:void(0);" title="选择链接">选择链接</a>
                            </div>
                        </div>
                    </div>
                </div>
