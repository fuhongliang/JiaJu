...
<div class="pd-white-box">
    <div class="table-act-row">
        <a class="btn btn-primary btn-sm blue_new" href="<?= $urlManager->createUrl(['mch/store/express-edit']) ?>">添加设置项</a>
        <a class="btn btn-primary btn-sm blue_new" href="javascript:void(0);" data-toggle="modal" data-target="#sender">设置发件人信息</a>
        <a class="btn btn-primary btn-sm blue_new" href="javascript:void(0);" onclick="CheckIsInstall()">检测是否安装打印插件</a>
    </div>
