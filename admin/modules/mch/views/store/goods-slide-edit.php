...
<div class="pd-white-box" id="app">
    <div class="wrap">
        <form class="auto-form" method="post" return="<?= $urlManager->createUrl(['mch/store/goods-slide']) ?>">
                ...
                <div class="col-sm-6">
                    <div class="input-group page-link-input">
                        ...
                        <div class="input-group-append">
                            <a class="btn btn-secondary pick-link-btn" href="javascript:void(0)">选择链接</a>
                        </div>
                    </div>
                </div>
            </div>
