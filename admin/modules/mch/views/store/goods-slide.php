...
<div class="pd-white-box">
    <div class="table-act-row">
        <a class="btn btn-primary btn-sm blue_new" href="<?= $urlManager->createAbsoluteUrl(['mch/store/goods-slide-edit']) ?>">添加轮播图</a>
    </div>
        ...
        <div class="card mb-3" style="display: inline-block;width: 300px">
            ...
            <div class="card-footer text-muted">
                <a class="btn btn-sm btn-primary"
                   href="<?= $urlManager->createUrl(['mch/store/goods-slide-edit', 'id' => $value['id']]) ?>">修改</a>
                <a class="btn btn-sm btn-danger del"
                   href="<?= $urlManager->createUrl(['mch/store/goods-slide-del', 'id' => $value['id']]) ?>">删除</a>
            </div>
        </div>
    <?php endforeach; ?>
