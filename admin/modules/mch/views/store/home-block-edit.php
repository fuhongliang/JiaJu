                    ...
                    <div class="row mb-3" v-for="(item,i) in pic_list">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group page-link-input">
                                ...
                                <div class="input-group-append">
                                    <a class="btn btn-secondary pick-link-btn" href="javascript:void(0)" open-type="navigate,wxapp">选择链接</a>
                                    <a class="btn btn-danger pic-delete" v-bind:data-index="i" href="javascript:void(0)">删除</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 col-form-label">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="radioOne" <?=$model->style == 0 ? "checked" : ""?>
                               value="0"
                               name="style" type="radio" class="custom-control-input">
                        <label class="custom-control-label" for="radioOne">默认样式</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline" v-if="pic_list.length>1">
                        <input id="radioTwo" <?=$model->style == 1 ? "checked" : ""?>
                               value="1"
                               name="style" type="radio" class="custom-control-input">
                        <label class="custom-control-label" for="radioTwo">默认样式</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline" v-if="pic_list.length==4">
                        <input id="radioThree" <?=$model->style == 2 ? "checked" : ""?>
                               value="2"
                               name="style" type="radio" class="custom-control-input">
                        <label class="custom-control-label" for="radioThree">默认样式</label>
                    </div>
                </div>
            </div>
