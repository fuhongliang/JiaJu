    ...
    <div class="wrap">
        ...
        <form class="" method="post">
            ...
            <div class="clearfix">
                ...
                <div class="right-box">
                    <div class="card mb-3 all-module-list">
                        <div class="card-header">可选模块</div>
                        <div class="card-body">
                ...
                <div class="right-box ml-4" style="width: 580px;">
                    <div class="card mb-3 all-module-list" v-if="selected == 'topic'">
                        <div class="card-header">专题自定义</div>
                    ...
                    <div class="card mb-3 all-module-list" v-if="selected == 'notice'">
                        <div class="card-header">公告自定义</div>
                        <div class="card-body" style="padding-right: 15px;">
                            <div class="form-group row">
                    ...
                    <!--视频自定义-->
                    <div class="card mb-3 all-module-list" :style="{display:selected=='video'?'block':'none'}">
                        <div class="card-header">视频自定义</div>
                        <div class="card-body" style="padding-right: 15px;">
                            <div class="form-group row">
                                <div class="form-group-label col-sm-3 text-right">
                    ...
                    <!--优惠券自定义-->
                    <div class="card mb-3 all-module-list" v-if="selected == 'coupon'">
                        <div class="card-header">优惠券自定义</div>
                        <div class="card-body" style="padding-right: 15px;">
                            <div class="form-group row">
                                <div class="form-group-label col-sm-3 text-right">
