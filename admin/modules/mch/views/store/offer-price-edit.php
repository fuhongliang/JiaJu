...
<div class="pd-white-box" id="app">
    <div class="wrap">
        ...
        <form class="auto-form-submit" method="post" return="<?= Yii::$app->urlManager->createUrl(['mch/store/free-delivery-rules']) ?>">
                ...
                <div class="col-sm-6 col-form-label">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input :checked="is_enable==1"
                               ...
                               name="is_enable"
                               type="radio"
                               class="custom-control-input" id="isEnableYes">
                        <label class="custom-control-label" for="isEnableYes">开启</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input :checked="detail.is_enable==0" v-model="is_enable"
                               ...
                               name="is_enable"
                               type="radio"
                               class="custom-control-input" id="isEnableNo">
                        <label class="custom-control-label" for="isEnableNo">关闭</label>
                    </div>
                </div>
            </div>
