...
<ul class="nav nav-tabs-custom">
    <li class="active"><a href="javascript:void(0);">门店</a></li>
    <span>/</span>
    <li><?= $this->title?></li>
</ul>
<?php $this->endBlock(); ?>
                        ...
                        <div class="upload-group multiple short-row">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <a class="btn btn-outline-secondary upload-file"  data-toggle="tooltip"
                                       data-placement="bottom" href="javascript:void(0);" title="上传文件"><span class="iconfont icon-shangchuan"></span></a>
                                    <a class="btn btn-outline-secondary select-file" data-toggle="tooltip"
                                       data-placement="bottom" href="javascript:void(0);" title="从文件库选择"><span class="iconfont icon-lishituku"></span></a>
                                </div>
                            </div>
