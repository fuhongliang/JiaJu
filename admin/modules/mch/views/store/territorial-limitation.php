        ...
        <form class="auto-form" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 col-form-label">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="isEnableYes" <?= $model['is_enable'] == 1 ? 'checked' : 'checked' ?>
                                value="1"
                                name="is_enable"
                                type="radio"
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="isEnableNo" <?= $model['is_enable'] == 0 ? 'checked' : null ?>
                                value="0"
                                name="is_enable"
                                type="radio"
                                class="custom-control-input">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 col-form-label">
                    ...
                    <a class="show-rules-modal" href="javascript:void(0);">[+新增条目]</a>
                </div>
            </div>
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
