...
<div class="pd-white-box" id="app" style="display: none">
    <div class="wrap">
            ...
            <div flex="dir:left box:first">
                ...
                <div class="right-box">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 col-form-label">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="topStyleOne" :checked="top_style==0?'checked':''"
                                       value="0"
                                       name="top_style" type="radio" class="custom-control-input" v-model="top_style">
                                <label class="custom-control-label" for="topStyleOne">样式一</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="topStyleTwo"  :checked="top_style==1?'checked':''"
                                       value="1"
                                       name="top_style" type="radio" class="custom-control-input" v-model="top_style">
                                <label class="custom-control-label" for="topStyleTwo">样式二</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="topStyleThree"  :checked="top_style==2?'checked':''"
                                       value="2"
                                       name="top_style" type="radio" class="custom-control-input" v-model="top_style">
                                <label class="custom-control-label" for="topStyleThree">样式三</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 col-form-label">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="isOrderOne" :checked="is_order==0?'checked':''"
                                       value="0"
                                       name="is_order" type="radio" class="custom-control-input" v-model="is_order">
                                <label class="custom-control-label" for="isOrderOne">隐藏</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="isOrderTwo"  :checked="is_order==1?'checked':''"
                                       value="1"
                                       name="is_order" type="radio" class="custom-control-input" v-model="is_order">
                                <label class="custom-control-label" for="isOrderTwo">样式二</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 col-form-label">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="isWalletNo" :checked="is_wallet==0?'checked':''"
                                       value="0"
                                       name="is_wallet" type="radio" class="custom-control-input" v-model="is_wallet">
                                <label class="custom-control-label" for="isWalletNo">隐藏</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="isWalletYes"  :checked="is_wallet==1?'checked':''"
                                       value="1"
                                       name="is_wallet" type="radio" class="custom-control-input" v-model="is_wallet">
                                <label class="custom-control-label" for="isWalletYes">开启</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 col-form-label">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="menuStyleOne" :checked="menu_style==0?'checked':''"
                                       value="0"
                                       name="menu_type" type="radio" class="custom-control-input" v-model="menu_style">
                                <label class="custom-control-label" for="menuStyleOne">列表形式</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="menuStyleTwo"  :checked="menu_style==1?'checked':''"
                                       value="1"
                                       name="menu_type" type="radio" class="custom-control-input" v-model="menu_style">
                                <label class="custom-control-label" for="menuStyleTwo">九宫格形式</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="modal edit-order-modal" tabindex="-1" role="dialog" style="z-index: 1041">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">订单栏图标编辑</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary edit-order-save">确认</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal add-menu-modal" tabindex="-1" role="dialog" style="z-index: 1041">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div style="background: #f6f8f9;padding: .5rem">
                        <div flex="dir:left box:justify cross:center"
                            ...
                            <div class="pl-3">{{item.name}}</div>
                            <div>
                                <a href="javascript:void(0)" class="add-menu" :data-index="index">添加</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal edit-menu-modal" tabindex="-1" role="dialog" style="z-index: 1041">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">菜单编辑</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body" v-if="edit_menu">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-primary edit-menu-save">确认</button>
                    </div>
                </div>
            </div>
        </div>
