    ...
    <div class="wrap">
        <form class="auto-form" method="post" return="<?= $urlManager->createUrl(['mch/topic/index']) ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 col-form-label">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="layoutSmallNo" value="0" <?= $model->layout == 0 ? 'checked' : null ?> name="layout" type="radio"
                               class="custom-control-input">
                        <label class="custom-control-label" for="layoutSmallNo">小图模式</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="layoutSmallYes" value="1" <?= $model->layout == 1 ? 'checked' : null ?> name="layout" type="radio"
                               class="custom-control-input">
                        <label class="custom-control-label" for="layoutSmallYes">大图模式</label>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 col-form-label">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="isChosenNo" value="0" <?= $model->is_chosen == 0 ? 'checked' : null ?> name="is_chosen" type="radio"
                               class="custom-control-input">
                        <label class="custom-control-label" for="isChosenNo">不精选</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="isChosenYes" value="1" <?= $model->is_chosen == 1 ? 'checked' : null ?> name="is_chosen" type="radio"
                               class="custom-control-input">
                        <label class="custom-control-label" for="isChosenYes">精选</label>
                    </div>
                </div>
            </div>
