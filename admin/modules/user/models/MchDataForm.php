...
class MchDataForm extends UserModel
{
    ...
    public function search()
    {
        ...
        $data = [
            ...
            'panel_4' => null,
            'panel_5' => [
                $this->getGoodsSaleTopList($todayStartTime, $todayEndTime, 7),
                $this->getGoodsSaleTopList($yesterdayStartTime, $yesterdayEndTime, 7),
                $this->getGoodsSaleTopList($lastSevenStartTime, $lastSevenEndTime, 7),
                $this->getGoodsSaleTopList($lastThirtyStartTime, $lastThirtyEndTime, 7),
            ],
        ];
    ...
    {
        $common = new CommonOrderStatistics();
        $goodsSaleTop = $common->getGoodsSaleTopList($startTime, $endTime, $this->mch_id);
