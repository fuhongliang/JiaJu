$.new_toast = function(args) {
    args = args || {};
    var content = args.content || "";
    var confirm = args.confirm || function () {};
    var id = $.randomString();
    var html = "<div class=\"toast fade show\" role=\"alert\" id=\""+ id + "\">"+
        "<div class=\"toast-body\">"+ content +"</div></div>";
    $("body").append(html);
    $("#"+id).on("show.bs.toast", function () {
        confirm();
    });
};
...
$.confirm = function (args) {
    ...
    var id = $.randomString();
    var html = "";
    html += "<div class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" data-backdrop=\"static\" id=\"" + id + "\">";
    html += "<div class=\"modal-dialog modal-sm\" role=\"document\">";
    html += "<div class=\"modal-content\">";
    if (args.title) {
        html += "<div class=\"modal-header\">";
        html += "<h5 class=\"modal-title\">" + args.title + "</h5>";
        html += "</div>";
    }
    html += "<div class=\"modal-body\">" + content + "</div>";
    html += "<div class=\"modal-footer\">";
    html += "<button type=\"button\" class=\"btn btn-primary alert-cancel-btn\">" + cancelText +"</button>";
    html += "<button type=\"button\" class=\"btn btn-danger alert-confirm-btn\">" + confirmText +"</button>";
    html += "</div>";
    html += "</div>";
    html += "</div>";
    html += "</div>";
...
$.alert = function (args) {
    ...
    var id = $.randomString();
    var html = "";
    html += "<div class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" data-backdrop=\"static\" id=\"" + id + "\" aria-hidden=\"true\">";
    html += "<div class=\"modal-dialog modal-sm\" role=\"document\">";
    html += "<div class=\"modal-content\">";
    if (args.title) {
        html += "<div class=\"modal-header\">";
